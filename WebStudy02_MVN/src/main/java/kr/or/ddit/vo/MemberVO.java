...
public class MemberVO implements Serializable{
   ...
   public MemberVO(@NotBlank(groups = { Default.class, DeleteGruop.class }) String memId,
			@NotBlank(groups = { Default.class, DeleteGruop.class }) @Size(min = 4, max = 8, groups = { Default.class,
					DeleteGruop.class }) String memPass) {
		super();
		this.memId = memId;
   ...
   @NotBlank(groups = {Default.class, DeleteGruop.class})
   private String memId;
   @NotBlank(groups = {Default.class, DeleteGruop.class})
   @Size(min=4, max=8, groups = {Default.class, DeleteGruop.class})
   @JsonIgnore
   ...
   private List<ProdVO> prodList; // has many 관계(1:N) <=일 : 다수의 관계
