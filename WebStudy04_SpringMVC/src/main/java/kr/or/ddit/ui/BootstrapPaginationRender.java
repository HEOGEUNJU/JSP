...
public class BootstrapPaginationRender implements PaginationRenderer {
   ...
   public String renderPagination(PagingVO<?> pagingVO) {
      String previoustPtrn = "<li class='page-item %s'><a class='page-link paging' %s data-page='%d'>Previous</a></li>";
      ...
      String currentPtrn     = "<li class='page-item active' aria-current='page'><a class='page-link paging'>%d</a></li>";
