...
//  @Test
   ...
   //  properties 읽는 방법
   //  1. Properties : 누가 읽는지, 메세지가 어떤 의미인지는 중요하지 않음
...
//	  2. ResourceBundle : 누가 읽고, 메세지가 어떤 의미인지 전달을 중요시함
