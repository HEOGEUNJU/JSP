...
<h4>Cookie</h4>
<pre>
	session (server에 저장) vs cookie (client에 저장)
...
// 		response.addCookie(domainCookie);
	...
	** 쿠키 속성들
	...
	부가 속성
		...
		maxAge : 쿠키의 만료 시한. 기본값은 세션과 동일한 만료 시한.	
				ex) -1(브라우저가 종료되면 삭제), 0 (name, value....등 모든 속성이 동일한 쿠키인 경우 삭제.)
		secure... 
</pre>
</body>
</html>