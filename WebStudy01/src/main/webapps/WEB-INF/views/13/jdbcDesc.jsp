...
<body>
<h4>JDBC(Java DataBase Conectivity)</h4>
<pre>
	jdbc 드라이버란? java.spl 패키지의 인터페이스들에 대한 구현 객체 모음.
	...
	5. 쿼리 객체 생성
		...
		- CallableStatement : function/ procedure 차이점 : function은 반환값이 존재 procedure는 반환값이 없음
							  function/ procedure 와 같은 절차적 코드 집합을 실행할 때 사용하는 쿼리 객체.
	6. 쿼리 실행
